...
// Barra fixa no rodape, sempre visivel mesmo depois de rolar a pagina -
// deixa o CTA de WhatsApp sempre "a mao" em vez de depender do usuario
// voltar pro topo. Some em telas maiores (o CTA normal ja basta la).
export function WhatsAppSticky({ campaignRef }: { campaignRef?: string }) {
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className="fixed inset-x-0 bottom-0 z-50 flex items-center justify-center gap-2 bg-[#25D366] py-3 text-sm font-semibold text-white shadow-[0_-2px_10px_rgba(0,0,0,0.1)] sm:hidden"
